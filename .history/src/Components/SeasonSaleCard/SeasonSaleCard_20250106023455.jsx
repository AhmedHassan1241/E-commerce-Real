      ...
      {items.map((item, index) => (
        ...
        >
          ...
          <div className="title1 text-center mt-3 w-100 mx-auto">
            ...
            <a href="#ShopNow" className="text-black fs-6 fw-semibold text-decoration-none py-1" style={{position:"absolute",bottom:"0",right: "50%"}}>
              <button className="btn btn-primary w-100 h-50">SHOP NOW</button>
            </a>
          </div>
        </div>
      ))}
