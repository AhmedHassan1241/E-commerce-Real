...
const CarouselSliderSale = () => {
  ...
  const items = [
    ...
    <img src="https://via.placeholder.com/600x300?text=Image+2" alt="Image 2" key={"2"} />,
    <img src="https://via.placeholder.com/600x300?text=Image+3" alt="Image 3" key={"3"} />,
    <img src="https://via.placeholder.com/600x300?text=Image+4" alt="Image 4" key={"4"} />,
  ];
