...
const HotData = () => {
  const video =
    "https://cmspreview-res.cloudinary.com/video/upload/v1716272651/MENA/tennis-SS24-roland-garros-launch-HP-teaser-card-portrait-dualgender-d_1.mp4";
  const data = [
    {
      image: sport01,
      title: "For the fast",
    ...
    },
    {
      ...
      description:
        "Connect to your practice in mind and body with our yoga range.",
    },
    {
      image: sport03,
    ...
    },
    {
      ...
      description:
        "The Messi Player Pack, follow in the footsteps of a legend.",
    },
    {
      video: video,
      title: "Paris tennis collection",
      description:
        "Discover the tennis range designed to provide best on court performance.",
    },
  ];
