  ...
  return (
    <div className="all">
      ...
      {!tokenExpiry ? (
        ...
        >
          <h2
            className="col-lg-5 col-md-6 m-0 p-0 "
            style={{ color: "#FFFFFF" }}
          >
      ...
      {/* <!-- BEFORE FOOTER --> */}
      {/* <!-- FOOTER --> */}
      <div className="footer bg-black pb-4">
        <div className="container-md pt-0 pt-md-5 h-100 ">
          <hr className="m-0 bg-light" style={{ height: "3px" }} />
          <div className="row text-light pt-5 row-gap-5">
            ...
            <WrapperFooterLink header={"follow us"}>
              <FooterLink href="#.">
                <FaFacebookSquare className="mb-2 fs-3"></FaFacebookSquare>
              </FooterLink>
              <FooterLink href="#.">
                <FaInstagram className="mb-2 fs-3"></FaInstagram>
              </FooterLink>
              <FooterLink href="#.">
                <FiYoutube className="mb-2 fs-3"></FiYoutube>
              </FooterLink>
            </WrapperFooterLink>
