...
const Yeezy = () => {
  return (
    <>
      <div
        className={styles["section-yazzy"]}
        style={{
      ...
      >
        <div className="container-fluid h-100">
          <div
            className={`${styles.LeftDiv} d-flex h-100 row }`}
            style={{ justifyContent: "left", alignItems: "center" }}
          >
            <div className="left col-md-6">
              <h1>YEEZY</h1>
              <p style={{ fontSize: "20px", maxWidth: "100%" }}>
                Access a limited selection of adidas YEEZY with up to 70% off.
              </p>
